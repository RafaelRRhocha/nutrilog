...
export const shoppingSections: ShoppingSection[] = [
  {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          {
            name: 'Pão de aveia / integral',
            quantity: '4 pães (~50–60 fatias)',
          },
        ],
      },
      {
        emoji: '🌱',
        name: 'Leguminosas',
        items: [{ name: 'Feijão', quantity: '1,5 kg cru' }],
      },
      {
        emoji: '🍪',
        name: 'Lanches',
        items: [
          { name: 'Biscoito de arroz', quantity: '2 pacotes' },
          { name: 'Geleia sem açúcar', quantity: '1 pote' },
        ],
      },
      {
        emoji: '🍯',
      ...
      },
      {
        emoji: '🥤',
        name: 'Suplemento',
        items: [{ name: 'Whey vegano', quantity: '1 pote (mín. 12 doses)' }],
      },
    ],
  },
  {
